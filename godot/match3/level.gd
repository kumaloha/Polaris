...
const COMBO_SWING_STEP := 0.30             # 每段时长(越小越快)
const COMBO_SWING_PAUSE := 0.45            # 每个来回后停顿(避免一直晃太吵)
...
const COMBO_LIGHT_NEAR := 0.18             # (旧分段法用, 已弃)光扫到的近端
const COMBO_LIGHT_FAR := 0.82              # (旧分段法用, 已弃)光扫到的远端
